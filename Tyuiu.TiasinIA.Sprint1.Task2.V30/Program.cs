...
namespace Tyuiu.TiasinIA.Sprint1.Task2.V30
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int x;
            Console.WriteLine("Введите значение х в километрах:");
            ...
            Console.WriteLine("Расстояние х в метрах = " + ds.ConvertKmToMetre(x)); 
